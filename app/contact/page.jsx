...
const page = () => {
  ...
  const Lib = [{ name: "إقرأ", address: "شارع القدس - الكويت" }];
  ...
  return (
    <div className="flex flex-col mdl:flex-row gap-2">
      ...
      {/* info section  */}
      <div className=" relative mdl:w-1/2 h-[490px] sm:h-[560px] mdl:h-[580px] m-8 bg-blue-200/60 rounded-lg">
        <div className="w-full absolute top-0 left-0 flex justify-center items-center -z-10">
          <Image
            width={400}
            height="auto"
          ...
          <div className="w-full h-full ">
            ...
            <div className="w-full flex flex-col font-TitleFont m-4 py-2">
              ...
              <div className="flex justify-start items-start flex-wrap gap-2 m-4">
                {Lib.map((elm, ind) => (
                  <div className=" bg-emerald-300/50 rounded-xl px-4 py-2">
                    <div className=" px-2 text-[14px] sml:text-xl flex justify-start items-start flex-wrap">
