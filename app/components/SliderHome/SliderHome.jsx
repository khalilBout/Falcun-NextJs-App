  ...
  const dataHeroSection = [
    {
      ...
      desc: "احصل على مذكرات مدرسية شاملة تساعد الأطفال على متابعة دروسهم وتحقيق أفضل النتائج مع محتوى منظم وسهل الاستخدام لكل مستوى",
      img: sct1,
      url: "/courses/books",
    },
    {
      title: " سلسلة التأسيس",
      desc: "ابدأ رحلة التعلم مع سلسلة التأسيس المصممة بعناية لتأسيس طفلك في القراءة في مادة اللغة الانجليزية  ",
      img: sct2,
      url: "/courses/series",
    },
    {
