...
const About = () => {
  return (
    <section className="screenPadding bg-teal-200/60 py-8 overflow-x-hidden">
        ...
        <div className=" flex justify-center items-center my-2">
          <p className="bg-gray-300/30 p-2 rounded-md md:px-4 xl:px-24  text-[16px] sml:text-[18px] mdl:text-[24px] font-bodyFont font-medium text-center ">
            ...
            <span className="text-cyan-900">
              ...
              أنها تجعلعملية التعلم مسلية و جذابة. علما أن هذه الفيديوهات مقدمة
              مجنا من فريق "برافو"
            </span>
          </p>
        </div>
      ...
      <div className="flex max-h-[280px] justify- gap-2 ">
        <div className=" flex justify-center items-center ">
          <p className="bg-gray-300/30 p-2 rounded-md md:px-4 xl:px-24  text-[16px] sml:text-[18px] mdl:text-[24px] font-bodyFont font-medium text-center ">
            ...
            <span className="text-cyan-900">
              دع طفلك يستمتع بتعلم القراءة من خلال سلسلة كتب مصممة خصيصا لتلبية
              احتياجاتهم التعليمية. حيث سيكتسب الأطفال مهارات القراءة بشكل
              تدريجي و منظم مما يعزز ثقتهم بأنفسهم و قدرتهم على التعلم . علما أن
              هذه الكتب هي عبارة عن 4 مستويات تبدأ من تعلم الحروف و تنتهي بقراءة
