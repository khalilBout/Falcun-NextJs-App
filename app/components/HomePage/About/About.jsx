      ...
      <div className="flex max-h-[280px] justify- gap-2 ">
        <div className=" flex justify-center items-center ">
          <p className="md:px-4 xl:px-24  text-[14px] sml:text-[18px] mdl:text-[24px] font-bodyFont font-medium ">
            موقعنا التعليمي للأطفال يوفر تجربة تعلم شاملة وممتعة من خلال ثلاثة
            مكونات رئيسية. نقدم فيديوهات تعليمية تفاعلية تجعل عملية التعلم مسلية
            وجذابة، مذكرات مدرسية متكاملة تساعد الأطفال على متابعة دروسهم وتنظيم
            معلوماتهم بشكل فعال، وسلسلة التأسيس المصممة بعناية لتأسيس مفاهيم
            قوية في المواد الأساسية من المستوى الأول حتى السادس.
          </p>
        </div>
